    ...
    return (
        <>
            <div className="mainContainer">
                ...
                <h2 className="sentence" style={{top: '150px'}}>
                    We specialize in creating platform agnostic web apps, custom<br/>
                    CMS and Ecommerce themes, server administration, data<br/>
                    migration and management, site migration and maintenance,<br/>
                    branding, UX/UI design, and project mtanagement.
                </h2>
